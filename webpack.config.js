...
Encore
    ...
    .addStyleEntry('main_page', ['./assets/styles/main_page.css'])
    .addStyleEntry('forgot', ['./assets/styles/recover_password.css'])
    .addStyleEntry('user_appointment', ['./assets/styles/user_appointment.css'])
